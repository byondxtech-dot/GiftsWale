      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Shop everything you need — from electronics to everyday essentials,
            books, vinyls, and posters — all in one place.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-600">
          <div className="flex items-center gap-4">
            ...
            <span>
              {" "}
              language
              <select className=" rounded px-2 py-1 text-sm outline-none ml-[-25px]">
                <option></option>
                <option>a</option>
              </select>
            </span>
